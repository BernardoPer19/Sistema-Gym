        ...
        <div className="flex flex-col items-center gap-6 md:flex-row md:items-start">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="rounded-lg border-4 border-neutral-800 bg-white p-4">
              {qrDataUrl ? (
                <img src={qrDataUrl || "/placeholder.svg"} alt="QR Code" className="h-64 w-64" />
              ) : (
            ...
            <Button onClick={handleDownloadQR} className="w-full gap-2 bg-primary hover:bg-primary/90">
          ...
          <div className="flex-1 space-y-4">
            <div>
              <h4 className="mb-2 text-sm font-semibold text-white">Código de Acceso</h4>
            ...
            <div className="space-y-2 rounded-lg border border-neutral-800 bg-neutral-900 p-4">
              <h4 className="text-sm font-semibold text-white">Formato del Código</h4>
              <div className="space-y-1 text-sm text-neutral-400">
                <p>
                  <span className="text-neutral-300">Nombre:</span> {member.name.toUpperCase()}
                </p>
                <p>
            ...
            <div className="rounded-lg border border-blue-500/20 bg-blue-500/10 p-4">
              <p className="text-sm text-blue-400">
                Este código QR es único para {member.name}. Puede ser escaneado en la recepción para registrar
                asistencias automáticamente.
              </p>
            </div>
          </div>
        </div>
